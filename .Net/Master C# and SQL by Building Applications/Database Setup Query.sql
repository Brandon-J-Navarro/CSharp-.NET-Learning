...
-- [] Used when using reserved key words such as 'dbo' or 'Description'
-- Feature 'Identity(1,1)' starts at 1 and adds one to each new customer
-- Constraints 'Not Null' can not be empty
-- 'Decimal(4,2)' up to 4 digits and 2 digits to the right of the decimal point
