...
namespace CourseManager.ViewModels
{
    internal class MainViewModel : Screen
    {
        ...
        private readonly string _connectionString = _configuration["_sqlConnectionStings:_msSQL"];
        ...
        public MainViewModel()
        {
            ...
            try
            {
                ...
                StudentCommand _studentCommand = new StudentCommand(_connectionString);
                Students.AddRange(_studentCommand.GetList());

                CourseCommand _courseCommand = new CourseCommand(_connectionString);
                Courses.AddRange(_courseCommand.GetList());
            }
            catch (Exception ex)
            {
        ...
        public void CreateNewEnrollment()
        {
            ...
            {
                SelectedEnrollment = new EnrollmentModel();
                UpdateAppStatus("New enrollment create");
            }
            catch (Exception ex)
            {
                UpdateAppStatus(ex.Message);
